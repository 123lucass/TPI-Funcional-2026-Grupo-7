...
// ========================================================================
def transicion(colorActual: String, cambiarA: String): (String, String) = {
  if (colorActual == "en-rojo" && cambiarA == "verde") {
...
// ========================================================================
def timer(timestampActual: Long): String = {
  val duracionTotal = 219    
  val momentoCiclo = timestampActual % duracionTotal

  if (momentoCiclo < 90) {
    "en-rojo" 
  } else if (momentoCiclo < 210) {
    "en-verde" 
  } else if (momentoCiclo < 216) {
    "en-amarillo" 
  } else {
