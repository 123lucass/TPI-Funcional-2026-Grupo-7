👤 Integrante 1: Lucas Rodolfo Silvano Dominguez- Usuario GitHub: 123lucass
...
Integrante 2: [Lucas Lombardi] - Usuario GitHub: [Lucaslomb286]
...
## Integrante 3: Gustavo Gabutti - Usuario GitHub: [Gustavo-Gabutti]
...
De acuerdo con los principios de honestidad académica, declaro que utilicé herramientas de IA bajo la modalidad de co-piloto y tutor técnico. El alcance de su intervención estuvo estrictamente delimitado a las siguientes tareas cooperativas de soporte y control de calidad:

1. **Detección de Bugs y Control de Tipado:** Asistencia para identificar por qué las divisiones enteras en Common Lisp daban cero al calcular estadísticas en el informe de uso, guiándome en el proceso de promoción de datos de enteros a flotantes (120.0, 219.0) para lograr cálculos con decimales.
...
---
**Declaración Jurada:** Al subir este archivo al repositorio, declaro bajo compromiso de honor que las marcas anteriores reflejan fielmente mi participación y la naturaleza del desarrollo de este trabajo práctico.
